    ...
    DropCreateDatabaseAlways<DataContext.AnimalsDataContext>
  {
    protected override void Seed(DataContext.AnimalsDataContext context)
    {
      if (IsDevelopmentEnvironment())
      {
        ...
        var herding = new Category
        {
          Name = "Herding",
          Description =
            "All breeds in the Herding Group share the fabulous ability to control the movement of other animals. A remarkable example is the low-set Corgi, perhaps one foot tall at the shoulders, that can drive a herd of cows many times its size to pasture by leaping and nipping at their heels. The vast majority of Herding dogs, as household pets, never cross paths with a farm animal. Nevertheless, pure instinct prompts many of these dogs to gently herd their owners, especially the children of the family. In general, these intelligent dogs make excellent companions and respond beautifully to training exercises."
        };
        ...
        context.Dogs.Add(new Dog
        {
          ...
          FullDescription =
            "im having to sell my scuffy little friend she is perfect in everyway she is house trained can be left a sensible lenth of time gets on with all different animals not nasty in any way adores children and is a perfect lapdog will sit on your kn....",
          Name = "Scuffy",
          IsLitter = false,
          IsSold = false,
          Price = 125,
        ...
        context.Dogs.Add(new Dog
        {
          ...
          FullDescription =
            "We have adorable bear headed black and white girls available. The puppies will be fleaed, wormed and vaccinated as well as vet checked. Your puppy will also have 4 weeks free insurance. They will be ready to leave us on 8th December, however....",
          Price = 700,
          Name = "",
          IsLitter = false,
          IsSold = false,
        ...
        context.Dogs.Add(new Dog
        {
          ...
          FullDescription =
            "beautiful Akita pup She born on 16/09/2013 she was warm And fleat she is full pedigree akita but she don't come with the KC registrert. reason for sale landlord don't accept dog. Please any more information call on 07587916471",
          Name = "lynn",
          IsLitter = false,
          IsSold = false,
          IsFemale = true,
        ...
        context.Dogs.Add(new Dog
        {
          ...
          FullDescription =
            "I have a lovely litter of 7 there is 6 left 3 girls 3boys looking for forever homes handled all the time be myself and my young children very playful ready to go they are eight week I also have mum and dad as there my pets more than welcome t....",
          Name = null,
          IsLitter = true,
          IsSold = false,
          IsFemale = true,
        ...
        context.Dogs.Add(new Dog
        {
          AgeInYears = 1,
          FullDescription =
            "WE ARE PROUD TO OFFER TWO EXCEPTIONAL MALE, AMERICAN AKITA PUPPIES. PUPPIES ARE KC REGISTERED AND HAVE BEEN FLEAD AND WORMED UP TO DATE.PUPPIES HAVE OUTSTANDING BONE STRUCTURE AND SUBSTANCE,COMPLIMENTED WITH A HEALTHY COAT.PUPPIES ARE 5 WEEKS...",
        ...
        context.Dogs.Add(new Dog
        {
          ...
          FullDescription =
            "A fairly old Alsatian requires a new home as we can't look after her anymore. Please get in touch. She likes walks and bones but other than that she's not high maintenance at all!",
          Name = "Spud",
          IsLitter = false,
          IsSold = false,
          IsFemale = true,
